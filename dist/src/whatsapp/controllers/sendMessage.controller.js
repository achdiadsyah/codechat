...
class SendMessageController {
    ...
    sendMedia({ instanceName }, data) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((data === null || data === void 0 ? void 0 : data.mediaMessage.mediatype) === 'document' && !((_b = data === null || data === void 0 ? void 0 : data.mediaMessage) === null || _b === void 0 ? void 0 : _b.fileName)) {
                throw new exceptions_1.BadRequestException('Enter the file name for the "document" type.');
            }
            if ((0, class_validator_1.isURL)((_c = data === null || data === void 0 ? void 0 : data.mediaMessage) === null || _c === void 0 ? void 0 : _c.media)) {
                return yield this.waMonitor.waInstances[instanceName].mediaMessage(data);
            }
        });
    }
    sendMediaFile({ instanceName }, data, file) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    sendWhatsAppAudioFile({ instanceName }, data, file) {
        return __awaiter(this, void 0, void 0, function* () {
            if ((data === null || data === void 0 ? void 0 : data.delay) && !(0, class_validator_1.isNumberString)(data.delay)) {
                throw new exceptions_1.BadRequestException('The "delay" property must have an integer.');
            }
